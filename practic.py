...
<main>
    ...
    <div class="container">
                ...
                <div class="col-4">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" placeholder="Введите адрес электронной почты">
                        </div>
                        <button type="button" class="w-100 btn dtn-lg btn-success">Отправить</button>
                    </form>
                </div>
        ...
        <div class="row">
            <div class="col">
                <a class="btn btn-success btn-lg" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button"
            ...
            <div class="col">
                <button class="btn btn-success btn-lg" type="button" data-bs-toggle="collapse"
                        ...
                        aria-expanded="false" aria-controls="multiCollapseExample3">Какая гарантия?
                </button>
            </div>
        </div>
        </p>
        <div class="row">
            ...
            <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample2">
                    <div class="card card-body">
                        Нажмите, чтобы увидеть условия доставки
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample3">
                    <div class="card card-body">
                        Нажмите, если хотите вернуть товар
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    def do_GET(self):
        query_comments = parse_qs(urlparse(self.path).query)
